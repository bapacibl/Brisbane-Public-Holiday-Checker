...
FixedHolidays = ["New Year's Day", "Australia Day", "ANZAC Day", "Christmas Day", "Boxing Day"]
FixedHolidates = ["0101", "2601", "2504", "2512", "2612"]
DayOffMoves = ["0101", "2601", "2512", "2612"]

#Holidays that have a floating date, except Easter.
ChangingHolidays = ["Labour Day", "Queen's Birthday", "Ekka Wednesday"]
...
if DateMonth in FixedHolidates:
    ...
    if (Month == "05") and (Day == "Mon") and ("01" <= Date <= "07"):
        ...
        print "It's probably " + ChangingHolidays[2] + ". If there's 5 Wednesdays this month, then it's next week"
